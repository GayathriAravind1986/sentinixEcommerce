...
import 'package:sentinix_ecommerce/UI/DeliveryApp/Authentication/Widget/signupdelivery_label_widget.dart';
import 'package:sentinix_ecommerce/UI/DeliveryApp/Authentication/login_delivery.dart';

class DeliveryManSignup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => DemoBloc(),
      child: DeliveryManSignupView(),
    );
  }
}

class DeliveryManSignupView extends StatefulWidget {
  const DeliveryManSignupView({
    super.key,
  });

  @override
  State<DeliveryManSignupView> createState() => _DeliveryManSignupViewState();
}

class _DeliveryManSignupViewState extends State<DeliveryManSignupView> {
