...
class PersonPickupDropScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => DemoBloc(),
      child: PersonPickupDropScreenView(),
    );
  }
}

class PersonPickupDropScreenView extends StatefulWidget {
  const PersonPickupDropScreenView({super.key});

  @override
  State<PersonPickupDropScreenView> createState() =>
      _PersonPickupDropScreenViewState();
}

class _PersonPickupDropScreenViewState
    extends State<PersonPickupDropScreenView> {
  ...
  Future<void> selectLocation() async {
    ...
    if (result != null) {
      ...
      setState(() {
        _packageController.text = address;
      });
    }
  }
